...
import {
  allocationsOf, assertAggregateCapacity, findOwnedOperationRun, stageAndValidate, stageRecipeWrapper,
...
export function createProjectTools({ makeTool, requirePolicy, requireState, publicState, config, runRemote, shell, userQuestions, jobs, requireRemoteAccess, projectSource: suppliedProjectSource }) {
  ...
  return { projectsTool, describeTool, inventoryTool, planTool, executeTool, statusTool, projectsDir, projectSource };
}
