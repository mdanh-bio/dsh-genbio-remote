...
// W0: "h100-direct" is the run-record source for genbio_h100_direct_* launches
// (lib/h100-direct.js Phase 0f). Without it the direct layer fail-closes BEFORE
// any remote side effect — the first real launch attempt caught this gap.
const SOURCES = new Set(["aizyme", "pinned", "project", "workflow", "manual", "h100-direct"]);
