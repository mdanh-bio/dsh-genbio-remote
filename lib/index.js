...
const DEFAULT_EXECUTION_REGISTRY_DIR = "/Users/mdanh/.dsh/profiles/desktop/genbio-execution-registry";
...
async function apply(ctx, config = {}) {
  ...
  const { projectsTool, describeTool: projectDescribe, inventoryTool, planTool: projectPlan, executeTool: projectExecute, statusTool: projectStatus, cancelTool: projectCancel, fetchTool: projectFetch } = createProjectTools({ makeTool, requirePolicy, requireState, publicState, config, runRemote, shell, userQuestions, jobs, requireRemoteAccess, projectSource, executionRegistry });
