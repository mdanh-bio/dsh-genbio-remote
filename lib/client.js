window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function GenbioDock({ sessionId, useSessions, useProjection }) {
      ...
      if (relevant.length === 0 && !envelope && runs.length === 0 && projects.length === 0 && projectsStatus.length === 0) return null;
        ...
        h("div", { className: "dgr-card" },
          ...
          h("div", { className: "dgr-menu" },
            ...
            h("div", { className: "dgr-panel", "data-open": panel === "details" ? "true" : "false" },
              ...
              h("div", { className: "dgr-row" }, h("strong", null, "Supported targets"), h("span", { className: "dgr-value" }, "HPC · genbio_mdanh · genbioh100")),
              ...
              projects.length ? h("div", { className: "dgr-section" },
                h("div", { className: "dgr-safe" }, "Project control is read-only. Declarative execution remains fail-closed until content-addressed exact-once submission is independently approved."),
            ...
            projectNames.length ? h("div", { className: "dgr-panel dgr-panel-wide", "data-open": panel === "projects" ? "true" : "false" },
              ...
              selectedAgg
                ? h("div", { className: "dgr-project-body" },
                    h("div", { className: "dgr-proj-note" }, "Read-only local aggregate; scheduler state is added with the execution integration. No execute or submit controls are exposed."),
